...
export const expeditions: { id: string; name: string; minutes: number; level: number; description: string; cost: Record<string, number>; reward: Record<string, number>; collection: string; skill: SkillId; xp: number; vehicle?: VehicleId }[] = [
  ...
  { id: "kestrel-relay", name: "Restore the Kestrel Relay", minutes: 3, level: 20, description: "Recommission a civilian relay so nearby stations can trade safely again.", cost: { circuits: 3, rations: 3 }, reward: { navData: 7, data: 5 }, collection: "expedition-kestrel-relay", skill: "logistics", xp: 340 },
  { id: "sunken-convoy", name: "Salvage the Sunken Convoy", minutes: 4, level: 24, description: "Recover sealed cargo pods from a convoy buried in the Erebus dust field.", cost: { rations: 4, powerCell: 1 }, reward: { salvage: 18, circuits: 5, plating: 2 }, collection: "expedition-sunken-convoy", skill: "salvage", xp: 390, vehicle: "boardingShuttle" },
  { id: "glass-canyon", name: "Cross the Glass Canyon", minutes: 5, level: 30, description: "Guide a rover through a razor-crystal canyon to assay its mineral seams.", cost: { fuelRod: 1, rations: 4 }, reward: { cobalt: 12, iridium: 3, phaseCrystal: 1 }, collection: "expedition-glass-canyon", skill: "mining", xp: 480, vehicle: "rover" },
  { id: "orchid-zone", name: "Catalogue the Orchid Zone", minutes: 5, level: 36, description: "Collect a living record of the Helix Reach's fast-adapting bloom colonies.", cost: { medicine: 3, data: 6 }, reward: { catalyst: 8, rations: 8, bioLumen: 2 }, collection: "expedition-orchid-zone", skill: "botany", xp: 560, vehicle: "rover" },
  { id: "sealed-infirmary", name: "Open the Sealed Infirmary", minutes: 6, level: 42, description: "Secure an abandoned clinic whose automated triage systems are still working.", cost: { medicine: 4, powerCell: 2, data: 4 }, reward: { medicine: 12, catalyst: 5, repairNanites: 2 }, collection: "expedition-sealed-infirmary", skill: "medicine", xp: 640, vehicle: "boardingShuttle" },
  { id: "prism-caverns", name: "Probe the Prism Caverns", minutes: 7, level: 50, description: "Read the electromagnetic patterns inside a moon-wide crystal cave system.", cost: { data: 8, powerCell: 2, fuelRod: 1 }, reward: { phaseCrystal: 5, data: 12, voidLens: 1 }, collection: "expedition-prism-caverns", skill: "science", xp: 760, vehicle: "rover" },
  { id: "family-vault", name: "Recover the Family Vault", minutes: 8, level: 58, description: "Board a dignitary transport and return its recovered history to the surviving line.", cost: { relic: 3, medicine: 4, rations: 5 }, reward: { relic: 10, artefact: 2, data: 6 }, collection: "expedition-family-vault", skill: "archaeology", xp: 900, vehicle: "boardingShuttle" },
  { id: "helix-wind-farm", name: "Restart the Helix Wind Farm", minutes: 9, level: 70, description: "Repair a field of atmospheric turbines without breaching the quarantine boundary.", cost: { plating: 5, circuits: 6, powerCell: 3 }, reward: { powerCell: 8, circuits: 10, repairNanites: 3 }, collection: "expedition-helix-wind-farm", skill: "engineering", xp: 1100, vehicle: "boardingShuttle" },
  { id: "black-box-treaty", name: "Negotiate the Black Box Treaty", minutes: 10, level: 82, description: "Broker a return agreement for recovered flight records between wary frontier crews.", cost: { data: 12, rations: 6, medicine: 4 }, reward: { navData: 14, commandToken: 1, relic: 4 }, collection: "expedition-black-box-treaty", skill: "diplomacy", xp: 1350, vehicle: "boardingShuttle" },
  { id: "corsair-cache", name: "Seize the Corsair Cache", minutes: 11, level: 96, description: "Board a hidden raider cache before its self-destruct sequence can erase it.", cost: { missiles: 8, rations: 6, medicine: 5 }, reward: { missiles: 14, plating: 8, quantumParts: 3 }, collection: "expedition-corsair-cache", skill: "combat", xp: 1600, vehicle: "boardingShuttle" },
  { id: "cinder-observatory", name: "Align the Cinder Observatory", minutes: 12, level: 110, description: "Use an abandoned observatory to identify a stable path through corsair space.", cost: { data: 14, fuelRod: 3, phaseCrystal: 2 }, reward: { navData: 20, voidData: 6, phaseFilament: 4 }, collection: "expedition-cinder-observatory", skill: "astrogation", xp: 1900, vehicle: "boardingShuttle" },
  { id: "broken-refinery", name: "Reclaim the Broken Refinery", minutes: 13, level: 125, description: "Bring a drifting micro-refinery online long enough to recover its rare alloy run.", cost: { ferrite: 15, cobalt: 12, powerCell: 4 }, reward: { titanium: 10, titaniumPlate: 6, quantumAlloy: 2 }, collection: "expedition-broken-refinery", skill: "metallurgy", xp: 2200, vehicle: "rover" },
  { id: "grey-market-run", name: "Trace the Grey Market Run", minutes: 14, level: 140, description: "Follow a chain of neutral stations to find a missing relief shipment.", cost: { rations: 8, medicine: 6, fuelRod: 3 }, reward: { droneParts: 10, circuits: 12, navData: 16 }, collection: "expedition-grey-market-run", skill: "logistics", xp: 2550, vehicle: "boardingShuttle" },
  { id: "rift-anchor", name: "Stabilise the Rift Anchor", minutes: 16, level: 160, description: "Patch an ancient anchor station before its broken field folds a supply route closed.", cost: { plating: 10, circuits: 12, phaseCrystal: 4 }, reward: { riftAlloy: 6, phaseLattice: 3, quantumCircuit: 4 }, collection: "expedition-rift-anchor", skill: "engineering", xp: 3000, vehicle: "boardingShuttle" },
  { id: "temporal-orchard", name: "Harvest the Temporal Orchard", minutes: 17, level: 185, description: "Collect a time-shifted crop that ripens and decays across the same hour.", cost: { medicine: 7, catalyst: 6, powerCell: 4 }, reward: { neuralGel: 8, genesisSeed: 2, bioLumen: 8 }, collection: "expedition-temporal-orchard", skill: "botany", xp: 3500, vehicle: "rover" },
  { id: "lost-flotilla", name: "Chart the Lost Flotilla", minutes: 18, level: 210, description: "Survey a silent fleet frozen in the outer edge of the Orpheus anomaly.", cost: { rations: 10, powerCell: 5, data: 16 }, reward: { salvage: 30, neutronium: 8, voidData: 10 }, collection: "expedition-lost-flotilla", skill: "salvage", xp: 4100, vehicle: "boardingShuttle" },
  { id: "pilgrims-preserve", name: "Secure the Pilgrims' Preserve", minutes: 19, level: 240, description: "Treat a dormant refuge population before the preserve's life support fails.", cost: { medicine: 10, catalyst: 7, fuelRod: 3 }, reward: { medicine: 20, neuralGel: 10, repairNanites: 6 }, collection: "expedition-pilgrims-preserve", skill: "medicine", xp: 4700, vehicle: "boardingShuttle" },
  { id: "mirror-wreck", name: "Explore the Mirror Wreck", minutes: 20, level: 270, description: "Document a duplicated vessel whose two histories diverged within the rift.", cost: { relic: 7, data: 18, phaseCrystal: 5 }, reward: { artefact: 5, voidLens: 4, sentinelCipher: 3 }, collection: "expedition-mirror-wreck", skill: "archaeology", xp: 5400, vehicle: "boardingShuttle" },
  { id: "void-nursery", name: "Sample the Void Nursery", minutes: 22, level: 310, description: "Collect a living matrix from a region where organic matter takes root in vacuum.", cost: { medicine: 12, neuralGel: 7, powerCell: 6 }, reward: { xenoFiber: 20, genesisCompound: 6, bioLumen: 12 }, collection: "expedition-void-nursery", skill: "biochemistry", xp: 6200, vehicle: "boardingShuttle" },
  { id: "prism-array", name: "Calibrate the Prism Array", minutes: 23, level: 350, description: "Tune a machine-era sensor array to resolve signals from beyond local time.", cost: { data: 24, relic: 8, phaseCrystal: 6 }, reward: { voidData: 18, phaseLattice: 6, quantumDust: 8 }, collection: "expedition-prism-array", skill: "science", xp: 7100, vehicle: "boardingShuttle" },
  { id: "gatekeeper-hulk", name: "Board the Gatekeeper Hulk", minutes: 25, level: 400, description: "Clear a sentinel command hulk that has awakened beside a restored transit gate.", cost: { missiles: 15, medicine: 12, powerCell: 7 }, reward: { ancientCore: 4, quantumParts: 14, neutroniumPlate: 4 }, collection: "expedition-gatekeeper-hulk", skill: "combat", xp: 8200, vehicle: "boardingShuttle" },
  { id: "twilight-platform", name: "Command the Twilight Platform", minutes: 26, level: 450, description: "Synchronise a dormant orbital platform with the cruiser’s drone control network.", cost: { droneParts: 12, circuits: 18, powerCell: 8 }, reward: { droneParts: 24, quantumCircuit: 8, sentinelCipher: 4 }, collection: "expedition-twilight-platform", skill: "drones", xp: 9400, vehicle: "boardingShuttle" },
  { id: "sentinel-demarcation", name: "Broker the Sentinel Demarcation", minutes: 28, level: 500, description: "Establish a temporary boundary with a machine enclave using its own protocol language.", cost: { data: 28, relic: 12, artefact: 3 }, reward: { commandToken: 2, sentinelCipher: 8, voidData: 16 }, collection: "expedition-sentinel-demarcation", skill: "diplomacy", xp: 10800, vehicle: "boardingShuttle" },
  { id: "rift-harvester", name: "Mine the Rift Harvester", minutes: 30, level: 550, description: "Strip a stranded autonomous extractor that has been collecting anomaly matter for centuries.", cost: { fuelRod: 5, powerCell: 8, phaseCrystal: 7 }, reward: { darkMatter: 10, neutronium: 14, riftAlloy: 10 }, collection: "expedition-rift-harvester", skill: "mining", xp: 12300, vehicle: "rover" },
  { id: "sarcophagus-relay", name: "Navigate the Sarcophagus Relay", minutes: 32, level: 650, description: "Plot a safe course through a relay corridor that closes behind every passing ship.", cost: { navData: 20, fuelRod: 6, phaseFilament: 6 }, reward: { voidData: 28, phaseLattice: 10, quantumDust: 12 }, collection: "expedition-sarcophagus-relay", skill: "astrogation", xp: 14000, vehicle: "boardingShuttle" },
  { id: "subterranean-observatory", name: "Excavate the Subterranean Observatory", minutes: 35, level: 720, description: "Unseal a buried observatory and recover its record of the first machine awakening.", cost: { relic: 15, powerCell: 9, neutroniumPlate: 4 }, reward: { ancientCore: 5, voidLens: 7, commandToken: 2 }, collection: "expedition-subterranean-observatory", skill: "archaeology", xp: 15800, vehicle: "boardingShuttle" },
  { id: "void-leviathan", name: "Track the Void Leviathan", minutes: 38, level: 780, description: "Shadow a colossal anomaly predator long enough to recover fragments from its wake.", cost: { missiles: 20, medicine: 15, fuelRod: 7 }, reward: { darkMatter: 14, ancientCore: 6, phaseFilament: 10 }, collection: "expedition-void-leviathan", skill: "combat", xp: 17700, vehicle: "boardingShuttle" },
  { id: "genesis-vault", name: "Open the Genesis Vault", minutes: 42, level: 850, description: "Analyse a protected seed vault left by an extinct interstellar ecology project.", cost: { data: 34, genesisSeed: 3, quantumCircuit: 10 }, reward: { genesisCompound: 12, bioLumen: 20, singularityCore: 1 }, collection: "expedition-genesis-vault", skill: "science", xp: 19800, vehicle: "boardingShuttle" },
  { id: "dream-archive", name: "Cultivate the Dream Archive", minutes: 46, level: 925, description: "Stabilise a neural archive whose memories are encoded in living tissue.", cost: { neuralGel: 14, medicine: 16, genesisCompound: 6 }, reward: { neuralGel: 24, xenoFiber: 28, genesisSeed: 4 }, collection: "expedition-dream-archive", skill: "biochemistry", xp: 22100, vehicle: "boardingShuttle" },
  { id: "starfall-beacon", name: "Light the Starfall Beacon", minutes: 52, level: 1100, description: "Unite distant stations around a recovered beacon that can call every surviving crew home.", cost: { commandToken: 2, singularityCore: 1, voidData: 60 }, reward: { commandToken: 4, phaseLattice: 18, genesisCompound: 10 }, collection: "expedition-starfall-beacon", skill: "diplomacy", xp: 25000, vehicle: "boardingShuttle" },
];
...
export const collectionEntries = [
  ...
  ["expedition-kestrel-relay", "Kestrel Relay", "Expeditions"], ["expedition-sunken-convoy", "Sunken Convoy", "Expeditions"],
  ["expedition-glass-canyon", "Glass Canyon", "Expeditions"], ["expedition-orchid-zone", "Orchid Zone", "Expeditions"],
  ["expedition-sealed-infirmary", "Sealed Infirmary", "Expeditions"], ["expedition-prism-caverns", "Prism Caverns", "Expeditions"],
  ["expedition-family-vault", "Family Vault", "Expeditions"], ["expedition-helix-wind-farm", "Helix Wind Farm", "Expeditions"],
  ["expedition-black-box-treaty", "Black Box Treaty", "Expeditions"], ["expedition-corsair-cache", "Corsair Cache", "Expeditions"],
  ["expedition-cinder-observatory", "Cinder Observatory", "Expeditions"], ["expedition-broken-refinery", "Broken Refinery", "Expeditions"],
  ["expedition-grey-market-run", "Grey Market Run", "Expeditions"], ["expedition-rift-anchor", "Rift Anchor", "Expeditions"],
  ["expedition-temporal-orchard", "Temporal Orchard", "Expeditions"], ["expedition-lost-flotilla", "Lost Flotilla", "Expeditions"],
  ["expedition-pilgrims-preserve", "Pilgrims' Preserve", "Expeditions"], ["expedition-mirror-wreck", "Mirror Wreck", "Expeditions"],
  ["expedition-void-nursery", "Void Nursery", "Expeditions"], ["expedition-prism-array", "Prism Array", "Expeditions"],
  ["expedition-gatekeeper-hulk", "Gatekeeper Hulk", "Expeditions"], ["expedition-twilight-platform", "Twilight Platform", "Expeditions"],
  ["expedition-sentinel-demarcation", "Sentinel Demarcation", "Expeditions"], ["expedition-rift-harvester", "Rift Harvester", "Expeditions"],
  ["expedition-sarcophagus-relay", "Sarcophagus Relay", "Expeditions"], ["expedition-subterranean-observatory", "Subterranean Observatory", "Expeditions"],
  ["expedition-void-leviathan", "Void Leviathan", "Expeditions"], ["expedition-genesis-vault", "Genesis Vault", "Expeditions"],
  ["expedition-dream-archive", "Dream Archive", "Expeditions"], ["expedition-starfall-beacon", "Starfall Beacon", "Expeditions"],
] as const;
